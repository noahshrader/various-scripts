...
// ES5-compatible transparent shader background (no arrows, no const/let, no template literals)
// Picks two distinct light colors per load; initializes on .patternbg

// -------- Palette (light variants only) --------
var LIGHT_COLORS = [
  "#D2FFFC", // Aqua Light
...
var fragmentShader = [
  ...
  "  finalColor += (blob1Mask + blob2Mask) * (d * 0.02);",
...
function initShaderBackgrounds() {
  ...
  for (var i = 0; i < elements.length; i++) {
    try { new ShaderBackground(elements[i]); } catch(e){ console.warn(e); }
  }
}
